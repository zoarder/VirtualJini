 ...
 * <p>
 * This is the ImageCache class of gallery media.
 * @file ImageCache.java
 * <p>
 * This is the ImageCache class of gallery media.
 * @file ImageCache.java
...
public class ImageCache {
    ...
    private void init(ImageCacheParams cacheParams) {
        ...
        if (mCacheParams.memoryCacheEnabled) {
            if (BuildConfig.DEBUG) {
                ShowLog.e(TAG, "Memory cache created (size = "
                ...
                if (mCacheParams.diskCacheEnabled && diskCacheDir != null) {
                    ...
                    if (getUsableSpace(diskCacheDir) > mCacheParams.diskCacheSize) {
                        try {
                            ...
                            if (BuildConfig.DEBUG) {
                                ShowLog.e(TAG, "Disk cache initialized");
                            }
                        } catch (final IOException e) {
                            mCacheParams.diskCacheDir = null;
                            ShowLog.e(TAG, "initDiskCache - " + e);
                        }
                    }
                }
            }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    ShowLog.e(TAG, "addBitmapToCache - " + e);
                } catch (Exception e) {
                    ShowLog.e(TAG, "addBitmapToCache - " + e);
                } finally {
                    try {
    ...
    public BitmapDrawable getBitmapFromMemCache(String data) {
        ...
        if (BuildConfig.DEBUG && memValue != null) {
            ShowLog.e(TAG, "Memory cache hit");
        }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    ShowLog.e(TAG, "getBitmapFromDiskCache - " + e);
                } finally {
                    try {
                        if (inputStream != null) {
                            inputStream.close();
    ...
    public void clearCache() {
        if (mMemoryCache != null) {
            ...
            if (BuildConfig.DEBUG) {
                ShowLog.e(TAG, "Memory cache cleared");
            }
        }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null && !mDiskLruCache.isClosed()) {
                try {
                    ...
                    if (BuildConfig.DEBUG) {
                        ShowLog.e(TAG, "Disk cache cleared");
                    }
                } catch (IOException e) {
                    ShowLog.e(TAG, "clearCache - " + e);
                }
                mDiskLruCache = null;
                initDiskCache();
            }
        ...
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache != null) {
                try {
                    mDiskLruCache.flush();
                    if (BuildConfig.DEBUG) {
                        ShowLog.e(TAG, "Disk cache flushed");
                    }
                } catch (IOException e) {
            ...
            if (mDiskLruCache != null) {
                try {
                    if (!mDiskLruCache.isClosed()) {
                        ...
                        mDiskLruCache = null;
                        if (BuildConfig.DEBUG) {
                            ShowLog.e(TAG, "Disk cache closed");
                        }
                    }
                } catch (IOException e) {
                    ShowLog.e(TAG, "close - " + e);
                }
            }
        }
    }
