...
public class AboutUsActivity extends BaseActivity {
    ...
    @Override
    void setupActionBar() {
        Toolbar toolbar = (Toolbar) findViewById(R.id.activity_about_us_parent_tb);
    ...
    void startNextWithAnimation(Intent intent, boolean isFinish) {
        ...
        int adCounter = SharedPreferencesManager.getIntegerSetting(AboutUsActivity.this, AFCHealthConstants.AD_COUNTER, 0);
        SharedPreferencesManager.setIntegerSetting(AboutUsActivity.this, AFCHealthConstants.AD_COUNTER, ++adCounter);
