...
public class SplashScreenActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(3000, 100) {
            ...
            public void onTick(long millisUntilFinished) {
                onProgressDialog(getString(R.string.text_loading), mProgressBarIndex += 3);
            }
    ...
    void startNextWithAnimation(Intent intent, boolean isFinish) {
        ...
        int adCounter = SharedPreferencesManager.getIntegerSetting(SplashScreenActivity.this, AFCHealthConstants.AD_COUNTER, 0);
        SharedPreferencesManager.setIntegerSetting(SplashScreenActivity.this, AFCHealthConstants.AD_COUNTER, ++adCounter);
