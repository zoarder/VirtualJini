...
public class MyPostedFragment extends Fragment {

    private static final String TAG = MyPostedFragment.class.getSimpleName();
    private RecyclerView rv;
    private MyPostedAdapter adapter;
...
//        pDialog.setMessage("Loading My Posts...");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_my_posted, container, false);

        rv = (RecyclerView) rootView.findViewById(R.id.fragment_my_posted_parent_rv);
        ev = (TextView) rootView.findViewById(R.id.fragment_my_posted_empty_list_tv);
...
//        preparePostItems();
        ...
        mPostItems.add(null);
        adapter = new MyPostedFragment.MyPostedAdapter();
...
//                            .setAction("Action", null).show();
        ...
        FloatingActionButton fab = (FloatingActionButton) rootView.findViewById(R.id.fragment_my_posted_fab);
...
//                        pDialog.show();
    ...
    class MyPostedAdapter extends RecyclerView.Adapter {
        ...
        public class MyPostedViewHolder extends RecyclerView.ViewHolder {
            ...
            public ImageView my_posted_item_layout_main_iv;
            public ProgressBar my_posted_item_layout_image_pb;
            public TextView my_posted_item_layout_title_tv;
            public TextView my_posted_item_layout_type_tv;
            public TextView my_posted_item_layout_bed_room_tv;
            public TextView my_posted_item_layout_bath_room_tv;
            public TextView my_posted_item_layout_car_parking_tv;
            public TextView my_posted_item_layout_living_room_tv;
            public TextView my_posted_item_layout_dyning_room_tv;
            public TextView my_posted_item_layout_address_tv;
            public TextView my_posted_item_layout_size_tv;
            public TextView my_posted_item_layout_rent_tv;
            public TextView my_posted_item_layout_available_from_tv;
//            public Button my_posted_item_layout_add_wishlist_bt;

            public MyPostedViewHolder(View v) {
                super(v);

                mParentCardView = (CardView) v.findViewById(R.id.my_posted_item_layout_parent_cv);
                my_posted_item_layout_main_iv = (ImageView) v.findViewById(R.id.my_posted_item_layout_main_iv);
                my_posted_item_layout_image_pb = (ProgressBar) v.findViewById(R.id.my_posted_item_layout_image_pb);
                my_posted_item_layout_title_tv = (TextView) v.findViewById(R.id.my_posted_item_layout_title_tv);
                my_posted_item_layout_type_tv = (TextView) v.findViewById(R.id.my_posted_item_layout_type_tv);
                my_posted_item_layout_bed_room_tv = (TextView) v.findViewById(R.id.my_posted_item_layout_bed_room_tv);
                my_posted_item_layout_bath_room_tv = (TextView) v.findViewById(R.id.my_posted_item_layout_bath_room_tv);
                my_posted_item_layout_car_parking_tv = (TextView) v.findViewById(R.id.my_posted_item_layout_car_parking_tv);
                my_posted_item_layout_living_room_tv = (TextView) v.findViewById(R.id.my_posted_item_layout_living_room_tv);
                my_posted_item_layout_dyning_room_tv = (TextView) v.findViewById(R.id.my_posted_item_layout_dyning_room_tv);
                my_posted_item_layout_address_tv = (TextView) v.findViewById(R.id.my_posted_item_layout_address_tv);
                my_posted_item_layout_size_tv = (TextView) v.findViewById(R.id.my_posted_item_layout_size_tv);
                my_posted_item_layout_rent_tv = (TextView) v.findViewById(R.id.my_posted_item_layout_rent_tv);
                my_posted_item_layout_available_from_tv = (TextView) v.findViewById(R.id.my_posted_item_layout_available_from_tv);
//                my_posted_item_layout_add_wishlist_bt = (Button) v.findViewById(R.id.my_posted_item_layout_add_wishlist_bt);
            }
        }
...
//                            pDialog.show();
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent,
            ...
            if (viewType == VIEW_ITEM) {// create a new view
                View v = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.my_posted_item_layout, parent, false);
                // set the view's size, margins, paddings and layout parameters
                vh = new MyPostedViewHolder(v);
            } else {
        ...
        public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof MyPostedViewHolder) {
                ((MyPostedViewHolder) holder).my_posted_item_layout_title_tv.setText(mPostItems.get(position).getToletTitle());
                ((MyPostedViewHolder) holder).my_posted_item_layout_type_tv.setText(mPostItems.get(position).getToletType());
                ((MyPostedViewHolder) holder).my_posted_item_layout_address_tv.setText(mPostItems.get(position).getToletAddress());
                ((MyPostedViewHolder) holder).my_posted_item_layout_available_from_tv.setText(mPostItems.get(position).getToletFrom());
                ((MyPostedViewHolder) holder).my_posted_item_layout_size_tv.setText(mPostItems.get(position).getToletSqfeet() + " SQFT");
                ((MyPostedViewHolder) holder).my_posted_item_layout_rent_tv.setText("BDT " + mPostItems.get(position).getToletRent() + "/Month");
//                ((MyPostedViewHolder) holder).my_posted_item_layout_add_wishlist_bt.setTag(position);

                if (Integer.parseInt(mPostItems.get(position).getToletBedRoom()) > 0) {
                    ((MyPostedViewHolder) holder).my_posted_item_layout_bed_room_tv.setText(mPostItems.get(position).getToletBedRoom() + "");
                } else {
                    ((MyPostedViewHolder) holder).my_posted_item_layout_bed_room_tv.setVisibility(View.GONE);
                }

                if (Integer.parseInt(mPostItems.get(position).getToletBathRoom()) > 0) {
                    ((MyPostedViewHolder) holder).my_posted_item_layout_bath_room_tv.setText(mPostItems.get(position).getToletBathRoom() + "");
                } else {
                    ((MyPostedViewHolder) holder).my_posted_item_layout_bath_room_tv.setVisibility(View.GONE);
                }

                if (Integer.parseInt(mPostItems.get(position).getToletCarParking()) > 0) {
                    ((MyPostedViewHolder) holder).my_posted_item_layout_car_parking_tv.setText(mPostItems.get(position).getToletCarParking() + "");
                } else {
                    ((MyPostedViewHolder) holder).my_posted_item_layout_car_parking_tv.setVisibility(View.GONE);
                }

                if (Integer.parseInt(mPostItems.get(position).getToletLivingRoom()) > 0) {
                    ((MyPostedViewHolder) holder).my_posted_item_layout_living_room_tv.setText(mPostItems.get(position).getToletLivingRoom() + "");
                } else {
                    ((MyPostedViewHolder) holder).my_posted_item_layout_living_room_tv.setVisibility(View.GONE);
                }

                if (Integer.parseInt(mPostItems.get(position).getToletDyningRoom()) > 0) {
                    ((MyPostedViewHolder) holder).my_posted_item_layout_dyning_room_tv.setText(mPostItems.get(position).getToletDyningRoom() + "");
                } else {
                    ((MyPostedViewHolder) holder).my_posted_item_layout_dyning_room_tv.setVisibility(View.GONE);
                }

//                ((MyPostedViewHolder) holder).my_posted_item_layout_add_wishlist_bt.setOnClickListener(new View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
...
//                });
                ...
                ImageLoader.getInstance()
                        .displayImage(mPostItems.get(position).getTitleImage(), ((MyPostedViewHolder) holder).my_posted_item_layout_main_iv, options, new SimpleImageLoadingListener() {
                            @Override
                            public void onLoadingStarted(String imageUri, View view) {
                                ((MyPostedViewHolder) holder).my_posted_item_layout_image_pb.setProgress(0);
                                ((MyPostedViewHolder) holder).my_posted_item_layout_image_pb.setVisibility(View.VISIBLE);
                            }

                            @Override
                            public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                                ((MyPostedViewHolder) holder).my_posted_item_layout_image_pb.setVisibility(View.GONE);
                            }
                            ...
                            public void onProgressUpdate(String imageUri, View view, int current, int total) {
                                ((MyPostedViewHolder) holder).my_posted_item_layout_image_pb.setProgress(Math.round(100.0f * current / total));
                            }
                        });
            } else {
